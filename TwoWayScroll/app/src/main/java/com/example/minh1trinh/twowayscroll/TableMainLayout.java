...
import com.example.minh1trinh.twowayscroll.helpers.DatabaseHelpers;
...
public class TableMainLayout extends RelativeLayout {
    ...
    public TableMainLayout(Context context) {
        ...
        DatabaseHelpers databaseHelpers = new DatabaseHelpers(this.getContext());
      /*  databaseHelpers.insertCheckBox(new CheckBoxObject("AA",true));
        databaseHelpers.insertCheckBox(new CheckBoxObject("BB",false));*/
        Log.e("Size", databaseHelpers.getCountCheckBox() + "");
    ...
    TableRow taleRowForTableD(SampleObject sampleObject) {
        ...
        for (int x = 0; x < loopCount; x++) {
            ...
            checkBox.setText(info[x]);
            checkBox.setChecked(false);
            final DatabaseHelpers databaseHelpers = new DatabaseHelpers(getContext());
            final CheckBoxObject checkBoxObject = new CheckBoxObject(checkBox.getText().toString(), checkBox.isChecked());


            // TextView textViewB = this.bodyTextView(info[x]);
            List<CheckBoxObject>checkBoxObjects = databaseHelpers.getAllCheckBox();
            for(int i = 0; i < checkBoxObjects.size() ; i++){
                if(checkBoxObjects.get(i).getTextCheckBox().equals(checkBox.getText().toString())){
                    if(checkBoxObjects.get(i).getChecked()){
                        checkBox.setChecked(true);
                        System.out.println(checkBoxObjects.get(i).getTextCheckBox() + " and " + checkBox.getText().toString());
          ...
          //  databaseHelpers.insertCheckBox(new CheckBoxObject(checkBox.getText().toString(), checkBox.isChecked()));
            ...
            checkBox.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    databaseHelpers.updateCheckBox1(checkBoxObject);
                }
            });
    ...
    TextView bodyTextView(String label) {
        ...
        bodyTextView.setPadding(25, 25, 25, 25);
    ...
    TextView headerTextView(String label) {
        ...
        headerTextView.setPadding(52, 25, 25, 25);
